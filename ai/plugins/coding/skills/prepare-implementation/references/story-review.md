...
- Use at most two evidence-gathering tool turns, then return the result as the
  third step. OpenCode enforces `steps: 3`; in Codex this is a behavioral budget,
  subject to the parent runtime rather than equivalent native enforcement.
